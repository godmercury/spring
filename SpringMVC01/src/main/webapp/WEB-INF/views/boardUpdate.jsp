...
<div class="container">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
    	<form id="" method="post" action="../boardUpdate.do">
    		...
    		<table class="table">
    			...
    			<tr>
    				<th>내용</th>
    				<td><textarea name="content" rows="7" class="form-control">${vo.content}</textarea></td>
    			</tr>
    			<tr>
    				<th>작성자</th>
    				<td><input type="text" name="writer" class="form-control" value="${vo.writer}" readonly /></td>
    			</tr>
    			<tr>
